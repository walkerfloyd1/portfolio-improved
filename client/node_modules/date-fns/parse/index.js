...
function parse(dirtyDateString, dirtyFormatString, dirtyBaseDate, dirtyOptions) {
  ...
  for (i = 0; i < tokens.length; i++) {
    ...
    if (!options.useAdditionalWeekYearTokens && (0, _index15.isProtectedWeekYearToken)(token)) {
      (0, _index15.throwProtectedError)(token);
    }
    if (!options.useAdditionalDayOfYearTokens && (0, _index15.isProtectedDayOfYearToken)(token)) {
      (0, _index15.throwProtectedError)(token);
    }
